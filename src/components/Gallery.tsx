...
const images: GalleryImage[] = [
  { src: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&w=800&q=80', alt: 'Consultório odontológico moderno e equipado', caption: 'Nosso Consultório' },
  { src: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?auto=format&fit=crop&w=800&q=80', alt: 'Atendimento odontológico humanizado', caption: 'Atendimento Humanizado' },
  { src: 'https://images.unsplash.com/photo-1588776814546-1ffcf47267a5?auto=format&fit=crop&w=800&q=80', alt: 'Procedimento odontológico com tecnologia avançada', caption: 'Tecnologia Avançada' },
  { src: 'https://images.unsplash.com/photo-1609840114035-3c981b782dfe?auto=format&fit=crop&w=800&q=80', alt: 'Equipamentos de última geração', caption: 'Equipamentos Modernos' },
  { src: 'https://images.unsplash.com/photo-1571772996211-2f02c9727629?auto=format&fit=crop&w=800&q=80', alt: 'Ambiente acolhedor da clínica', caption: 'Ambiente Acolhedor' },
];
